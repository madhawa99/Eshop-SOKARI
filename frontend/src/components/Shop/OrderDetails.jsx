    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      <div className="w-full flex items-center justify-between">
        ...
        <Link to="/dashboard-orders">
          <div
            className={`${styles.button} !bg-cyan-500 !rounded-[4px] text-white font-[600] !h-[45px] text-[18px]`}
          >
            Order List
          </div>
        </Link>
      ...
      <div className="w-full flex items-center justify-between pt-6">
        ...
        <h5 className="text-[#00000084] text-white">
      ...
      <br />
      <br />
      <h4 className="pt-3 text-[20px] font-[600] text-white">Order Status:</h4>
      ...
      <div
        className={`${styles.button} mt-5 !bg-cyan-600 !rounded-[4px] text-white font-[600] !h-[45px] text-[18px]`}
